/**
 * Originally created by Johny Reeves github.com/jonnyreeves/ts-prop-injection.
 * Potential modifications from original.
 */
...
export class Injector {
   ...
   * @param {*} value
   */
  register(injectionKey : string, value : any) : void {
